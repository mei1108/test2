    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-show="searchList.categoryName">
              {{ searchList.categoryName }}<i @click="closeCategoryName">×</i>
            </li>
            <li class="with-x" v-show="searchList.keyword">
              {{ searchList.keyword }}<i @click="closeKeyword">×</i>
            </li>
            <li class="with-x" v-show="searchList.trademark">
              {{ searchList.trademark.split(":")[1] }}<i @click="closeTrademark">×</i>
            </li>
            <li class="with-x" v-for="(attr,index) in searchList.props" :key="attr.attrId">
              {{ attr.split(":")[1] }}<i @click="closeAttr(index)">×</i>
            </li>
          </ul>
        </div>
        ...
        <div class="details clearfix">
          ...
          <Pagination :total="total" @getPageNo="getPageNo"/>
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag){
        //旧数据
        let originOrder = this.searchList.order;
