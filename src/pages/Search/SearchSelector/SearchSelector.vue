  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trademark in trademarkList" :key="trademark.tmId" @click="searchTrademark(trademark)">{{trademark.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
      ...
      <div class="fl value">
        <ul class="type-list"  >
          <li v-for="(attrValue,index) in attrs.attrValueList" :key="index">
            <a  @click="searchAttr(attrs,attrValue)">{{attrValue}}</a>
          </li>
        </ul>
      </div>
